/**
* @file server.cpp
* @brief This file contains the code for creating a server which listens at the port 8000, and does the error detection of the message sent by the client
*/
#include <bits/stdc++.h>
#include <string>
#include <unistd.h>
...
string correct(string cword)
{
    ...
    for (int i = 1; i <= csize; i++)
        cw[csize - i + 1] = int(cword[i - 1]) - int('0');
...
int main(int argc, char const *arguments[])
{
    ...
    cout << "The size of received encoded message is " << cword.length() << endl;
